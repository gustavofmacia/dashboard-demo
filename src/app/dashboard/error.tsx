  ...
  return (
    <div className="flex w-full flex-col items-center justify-center">
      ...
      <div className="flex flex-col items-center justify-center">
        <p className="mt-8 text-2xl font-bold text-gray-600 md:text-3xl lg:text-4xl">
          Server Error
        </p>

        <div className="mt-2 flex flex-col items-center gap-4">
          <h2 className="text-gray-500 md:text-lg xl:text-xl">
            Something went wrong!
          </h2>
          <button
            onClick={() => reset()}
            className="cursor-pointer rounded-2xl border bg-blue-700 px-4 py-2 text-white transition-all hover:bg-blue-500"
          >
            Try again
          </button>
        </div>
